    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form id="registro" name="registro" v-on:submit.prevent="registrar">
                ...
                <input type="text" id="dni" class="fadeIn third style-input" name="dni" maxlength="9" v-model="dni" disabled="disabled">
                <b-form-datepicker id="fechaNacimiento" name="fechaNacimiento" disabled="disabled" v-model="fechaNacimiento" :max="maxDate" class="mb-2 style-input" locale="es-MX"
                :date-format-options="{
                    day: '2-digit',
                    month: '2-digit',
                    year: 'numeric',
                ...
                <input type="submit" class="fadeIn fourth" value="Actualizar datos" :disabled="btnDisabled">
            </form>
        </div>
    </div>
</template>
...
<script>
    export default {
        ...
        methods: {
            ...
            datosTrabajador() {
                let idTabajador = localStorage.getItem('id');
                this.$Api.datosTrabajador(idTabajador).then((response) => {
